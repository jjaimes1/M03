...
public class Exercici4 {
	public static void main(String[] args) {
		...
		String path = "/home/users/inf/wiam2/iam26541596/Documents/jhonny/M03/NF3/exercicisFile/src/exercicisSol/pruebas";
		
		File [] arxius = new File(path).listFiles();
		int nBackup = detectarNumBackup(arxius);
		nBackup = nBackup+1;
		File backup = new File ("/home/users/inf/wiam2/iam26541596/Documents/jhonny/M03/NF3/exercicisFile/src/exercicisSol/pruebas"+subdirectori+nBackup);
		backup.mkdir();
